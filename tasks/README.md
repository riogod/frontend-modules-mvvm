...
|---|--------|--------|-------|-------------|
| 001 | [Реструктуризация проекта](./001-project-restructure.md) | ⚪ Не начата | 4-6ч | - |
| 002 | [Vite конфигурация для MFE модулей](./002-vite-module-config.md) | ⚪ Не начата | 6-8ч | 001 |
| 003 | [Базовая структура CLI Runner](./003-cli-launcher-base.md) | ⚪ Не начата | 4-6ч | 001 |
| 004 | [Менеджер конфигураций CLI](./004-cli-config-manager.md) | ⚪ Не начата | 6-8ч | 003 |
| 005 | [Генератор MFE модулей](./005-cli-module-generator.md) | ⚪ Не начата | 6-8ч | 002, 003 |
...
2. **Задача 002** - Vite конфигурация (параллельно)
