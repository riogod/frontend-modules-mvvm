...
Сервер для разработки с интеграцией MSW (Mock Service Worker).

## Описание

Dev-server работает на порту **1337** и перехватывает запросы, модифицируя ответы в зависимости от настроек конфигурации.
...
Dev-server автоматически читает:
