...
// Содержимое из docs/getting-started.md
const gettingStartedMarkdown = `# Быстрый старт
...
>
> \`\`\`bash
> node --version  # Должно быть v22.16.0 или выше
...
4. **Настройте разработку:** См. [Лаунчер](./tools/launcher.md) для деталей о режимах разработки
...
1. Убедитесь, что версия Node.js соответствует требованиям (22.16+)
...
Так же необходимо создать эндпоинт который будет отдавать манифест. (пример такого локального сервера для проведения тестов расположен в examples\\manifest-server)
...
> **Совет:** Если вы новичок в проекте, начните с изучения Архитектуры и Структуры проекта, чтобы понять, как организован код.
`;

/**
 * Страница быстрого старта.
 * Отображает содержимое из docs/getting-started.md
 *
 * @component
 */
