...
// Содержимое из docs/architecture.md
const architectureMarkdown = `# Архитектура платформы

Modular Frontend Platform (MFP) объединяет принципы чистой архитектуры, модульности и паттерна MVVM для построения масштабируемых frontend-приложений.
 ...
 * Отображает содержимое из docs/architecture.md
 *
 * @component
 */
  ...
  return (
    <Container maxWidth={false} sx={{ padding: 0 }}>
      ...
      <Paper sx={(theme) => ({ width: '100%', p: theme.spacing(6) })}>
        <MarkdownRenderer content={architectureMarkdown} />
      </Paper>
    </Container>
  );
};
