...
> Детали сборки смотрите в разделе [Сборка проекта](../tools/build.md).
...
- [Сборка проекта](../tools/build.md) — команды и конфигурация сборки
- [CI/CD](./cicd.md) — автоматизация сборки и деплоя
- [Мониторинг](./monitoring.md) — логирование и отслеживание ошибок
